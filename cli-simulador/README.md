...
```bash
# Verificar checksum
sha256sum -c cli-simulador-v2.0.1-windows-amd64.exe.sha256

# Verificar assinatura OIDC com Cosign
cosign verify-blob \
  --certificate cli-simulador-v2.0.1-windows-amd64.pem \
  --signature cli-simulador-v2.0.1-windows-amd64.sig \
  --certificate-identity-regexp "https://github.com/.*" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com" \
  cli-simulador-v2.0.1-windows-amd64.exe
```
